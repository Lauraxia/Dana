...
Offering.create([{:name => 'Free donuts', available: DateTime.parse("09/01/2009 17:00"), description: "from the boss", company_id_id: Company.find_by(name: 'Moneymaking Business')}])